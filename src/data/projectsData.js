...
const projectsData = [
  {
    ...
    // fonctionnalites:[["La recommandation.", "La collecte de données.","Acheter ou partager un produit."],
    // ["L’utilisateur reçoit des recommandations multi-critères et uniques de produits, basées sur ses centres d’intérêts. L’utilisateur parcours les recommandations en évaluant la pertinence de cette dernière : Swipe à droite “J’adore !”Swipe à gauche “Mh non merci.”",
    //   "L’utilisateur sélectionne les centres d’intérêts qui lui correspond afin de personnaliser leur expérience.",
    //   "Surprise, c’est un match ! L’utilisateur peut acheter un produit qu’il aime ou créer une liste de cadeau à partager a ses amis !",
    // ],],
    fonctionnalites: [
      {
    ...
    fonctionnalites: ["Profil de l'animal",
      "Choix d'un créneau de gardiennage",
      "Suivi via une messagerie sécurisée avec le catsitter."
    ],
